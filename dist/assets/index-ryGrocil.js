...
function LoginScreen({ onLogin, onRegister, loading }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "login-title", children: "🎭 0408" }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error-message", children: error }),
    showRegisterPrompt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "register-prompt", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "This user doesn't exist yet." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Would you like to register first?" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "login-form", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "btn btn-primary", disabled: loading, children: loading ? "Loading..." : isLogin ? "Login" : "Register" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-toggle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
...
function Sidebar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "sidebar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "🎭 0408" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "user-info", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "username", children: currentUser }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "user-id", children: [
        "ID: ",
        localStorage.getItem("userId") || "N/A"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "friends-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "friends-title", children: [
        "Friends ",
      ...
      onlineFriends.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "friends-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "group-label", children: "Online" }),
        onlineFriends.map((friend) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
      ...
      offlineFriends.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "friends-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "group-label", children: "Offline" }),
        offlineFriends.map((friend) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            className: `friend-item ${currentChatWith === friend.username ? "active" : ""}`,
            onClick: () => onSelectFriend(friend.username),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-dot offline" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "friend-name", children: friend.username })
            ]
          },
          friend.username
      ...
      friends.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "no-friends", children: "No friends yet" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onOpenRequests, className: "btn btn-small", children: "Requests" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onLogout, className: "btn btn-small btn-danger", children: "Logout" })
    ] })
  ] });
}
...
function ChatPanel({
  ...
  const [readReceipts, setReadReceipts] = reactExports.useState({});
  const messagesEndRef = reactExports.useRef(null);
  const pollingIntervalRef = reactExports.useRef(null);
  const friendStatusRef = reactExports.useRef({});
  const visibilityRef = reactExports.useRef(true);
  const focusRef = reactExports.useRef(false);
  const observerRef = reactExports.useRef(null);
  const visibleMessagesRef = reactExports.useRef(/* @__PURE__ */ new Set());
  ...
  reactExports.useEffect(() => {
    ...
    if (previousStatus !== void 0 && previousStatus !== friend.online) {
      const statusMessage = {
        type: "status",
  ...
  reactExports.useEffect(() => {
    ...
    const fetchHistory = async () => {
      try {
        const serverUrl = "wss://quidec-server.onrender.com";
  ...
  const markMessageAsRead = async (messageId) => {
    ...
    if (ws && ws.readyState === WebSocket.OPEN && currentChatWith) {
      ...
      ws.send(JSON.stringify({
        type: "mark-read",
        messageId,
        from: currentChatWith,
        // Recipient is marking as read
      ...
      if (response.ok) {
        ...
        setChatMessages((prev) => [
          ...prev,
          {
            ...
            recipientOffline
            // Track if recipient was offline when sent
          }
        ]);
      } else {
  ...
  if (!currentChatWith) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-panel empty", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { children: [
      "Select a friend to start chatting",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "or send a friend request to add new friends"
    ] }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-header", children: [
      onMobileBack && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mobile-back-btn", onClick: onMobileBack, children: "← Back" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: currentChatWith }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "messages-container", onScroll: handleScroll, children: [
      chatMessages.map((msg, idx) => {
        if (msg.type === "status") {
          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-message", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            msg.content,
            /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: new Date(msg.timestamp).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit", second: "2-digit" }) })
          ] }) }, idx);
        }
        const readInfo = readReceipts[msg.messageId];
        const recipient = friends.find((f) => f.username === currentChatWith);
        const recipientCurrentlyOnline = recipient?.online || false;
        let receiptState = "○ Sent";
        if (msg.read) {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-content", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "message-text", children: msg.content }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-footer", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "message-time", children: new Date(msg.timestamp).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit", second: "2-digit" }) }),
                msg.from === currentUser && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "read-receipt", children: readInfo ? `✓ Read ${new Date(readInfo.readAt).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit", second: "2-digit" })}` : receiptState })
              ] })
            ] })
          },
          idx
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSendMessage, className: "message-input-form", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "btn btn-send", children: "Send" })
    ] })
  ] });
}
...
function FriendRequestsModal({
  ...
  const [activeTab, setActiveTab] = reactExports.useState("incoming");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "requests-modal-overlay", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "requests-modal-content", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "requests-modal-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Friend Requests" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "requests-tabs", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "requests-list-container", children: [
      activeTab === "incoming" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "requests-list", children: !incomingRequests || incomingRequests.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No incoming requests" }),
        !incomingRequests && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "12px", color: "#666" }, children: "Debug: incomingRequests is null/undefined" })
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "request-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "request-info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "request-username", children: sender }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "request-type", children: "sent you a request" }),
            sentAtText && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "request-time", children: sentAtText })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "request-actions", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
      ...
      activeTab === "outgoing" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "requests-list", children: outgoingRequests.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No outgoing requests" }) }) : outgoingRequests.map((req) => {
        const recipient = typeof req === "string" ? req : req.recipient;
        const sentAt = typeof req === "string" ? null : req.sentAt;
        const sentAtText = sentAt ? new Date(sentAt).toLocaleDateString() : "";
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "request-item outgoing", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "request-info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "request-username", children: recipient }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "request-type", children: "pending..." }),
            sentAtText && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "request-time", children: sentAtText })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pending-badge", children: "⏳" })
        ] }, recipient);
      }) }),
      activeTab === "send" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "send-request-form", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "🆔 Enter 8-digit User ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
          ...
          error && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: "#ff6b6b", fontSize: "12px", marginBottom: "10px" }, children: [
            "❌ ",
            error
          ] })
        ] }),
...
function FriendRequestNotification({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `friend-request-notification ${isExiting ? "exiting" : "entering"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "notification-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "notification-message", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "notification-icon", children: "👋" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "notification-text", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "notification-title", children: "Friend Request" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "notification-user", children: [
            from,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "notification-progress" })
  ] });
}
...
function ChatScreen({
  ...
  const [currentChatWith, setCurrentChatWith] = reactExports.useState(null);
  const [notificationFrom, setNotificationFrom] = reactExports.useState(null);
  const [showRequestsModal, setShowRequestsModal] = reactExports.useState(false);
  const [mobileViewChat, setMobileViewChat] = reactExports.useState(false);
  const [isMobile, setIsMobile] = reactExports.useState(window.innerWidth < 768);
  reactExports.useEffect(() => {
    console.log("🔍 ChatScreen - friendRequests updated:", friendRequests);
  }, [friendRequests]);
  reactExports.useEffect(() => {
    const handleResize = () => {
  ...
  const handleSendFriendRequest = (input) => {
    console.log("\n========== 📤 SEND FRIEND REQUEST (ID ONLY) ==========");
    console.log("Step 1️⃣: Validating WebSocket connection...");
    ...
    console.log("\nStep 2️⃣: Building WebSocket message...");
    ...
    console.log("\nStep 3️⃣: Sending via WebSocket...");
    try {
    ...
    console.log("\nStep 4️⃣: Refreshing requests (500ms delay)...");
    setTimeout(() => {
      if (refreshRequests) {
        console.log("  Calling refreshRequests()...");
        refreshRequests();
        console.log("✅ Refresh complete");
      } else {
        console.warn("⚠️ refreshRequests callback not available");
      }
    }, 500);
    console.log("========== ✅ PROCESS COMPLETE ==========\n");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-screen", children: [
    (!mobileViewChat || !isMobile) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Sidebar,
      {
        currentUser,
        friends,
    ...
    notificationFrom && /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    showRequestsModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
      FriendRequestsModal,
      {
...
function useWebSocket(currentUser, onIncomingFriendRequest) {
  ...
  const onIncomingRef = reactExports.useRef(onIncomingFriendRequest);
  const reconnectAttemptsRef = reactExports.useRef(0);
  const reconnectTimeoutRef = reactExports.useRef(null);
  const maxReconnectAttemptsRef = reactExports.useRef(10);
  const serverUrlRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    ...
    const connectWebSocket = () => {
      ...
      const refreshRequestsHTTP = async () => {
        try {
          ...
          console.log("📥 HTTP: Incoming requests:", incomingData);
          ...
          console.log("📤 HTTP: Outgoing requests:", outgoingData);
        ...
        try {
          ...
          switch (message.type) {
            ...
            case "pending-requests":
              console.log("📥 Received incoming requests from server:", message.requests);
              setFriendRequests(message.requests || []);
              console.log("✅ Updated friendRequests state");
              break;
            case "outgoing-requests":
              console.log("📤 Received outgoing requests from server:", message.outgoing);
              setOutgoingRequests(message.outgoing || []);
              console.log("✅ Updated outgoingRequests state:", message.outgoing);
              break;
            case "request-sent":
              console.log("📤 Request sent successfully:", message);
            ...
            case "incoming-request":
              console.log("📥 Incoming request received:", message);
            ...
            case "request-declined":
              console.log("❌ Request declined:", message);
              setOutgoingRequests(
                (prev) => prev.filter((req) => {
                  const recipient = typeof req === "string" ? req : req.recipient;
              ...
              break;
            case "friend-request":
              setFriendRequests((prev) => [.../* @__PURE__ */ new Set([...prev, message.from])]);
              if (onIncomingRef.current) {
                onIncomingRef.current(message.from);
              }
              break;
            case "user-status":
              setFriends(
                (prev) => prev.map(
                  (f) => f.username === message.username ? { ...f, online: message.online } : f
                )
              );
              break;
            case "window-visibility":
              console.log(`👁️ Window visibility update from ${message.username}:`, message.visible ? "shown" : "hidden");
              setFriends(
                (prev) => prev.map(
                  (f) => f.username === message.username ? { ...f, windowVisible: message.visible } : f
                )
              );
              break;
            case "message":
              console.log("💬 Incoming message from:", message.from, message);
              break;
            case "typing":
              if (message.typing) {
                setTypingUsers((prev) => [.../* @__PURE__ */ new Set([...prev, message.from])]);
              } else {
                setTypingUsers(
                  (prev) => prev.filter((u) => u !== message.from)
                );
              }
              break;
            case "mark-read":
              console.log("📖 Real-time read receipt:", message);
              break;
            default:
      ...
      websocket.onopen = () => {
        ...
        console.log("✅ onmessage handler is set?", websocket.onmessage !== null);
        ...
        setTimeout(() => {
          console.log("⏱️ Requesting friends, pending, and outgoing requests...");
          websocket.send(JSON.stringify({
            type: "get-friends"
          }));
          console.log("📤 Sent get-friends message");
          websocket.send(JSON.stringify({
            type: "get-pending"
          }));
          console.log("📤 Sent get-pending message");
          websocket.send(JSON.stringify({
            type: "get-outgoing"
          }));
          console.log("📤 Sent get-outgoing message");
          setTimeout(() => {
            console.log("⏱️ Triggering HTTP fallback for friend requests...");
            refreshRequestsHTTP();
          }, 2e3);
        }, 500);
      };
      setInterval(() => {
        if (websocket.readyState === WebSocket.OPEN) {
          console.log("⏰ Periodic poll: fetching friends and requests...");
      ...
      websocket.onclose = () => {
        ...
        if (reconnectAttemptsRef.current < maxReconnectAttemptsRef.current) {
          const delayMs = Math.min(1e3 * Math.pow(2, reconnectAttemptsRef.current), 3e4);
  ...
  const refreshRequests = reactExports.useCallback(async () => {
    if (!currentUser) return;
    try {
      const serverUrl = "wss://quidec-server.onrender.com";
      const httpUrl = serverUrl.replace(/^wss:/, "https:").replace(/^ws:/, "http:");
...
function App() {
  ...
  const [incomingRequestFrom, setIncomingRequestFrom] = reactExports.useState(null);
  reactExports.useEffect(() => {
    const saved = localStorage.getItem("currentUser");
    if (saved) {
      console.log("🔓 Restoring session for:", saved);
  ...
  if (!currentUser) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LoginScreen, { onLogin: handleLogin, onRegister: handleRegister, loading });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ChatScreen,
    {
