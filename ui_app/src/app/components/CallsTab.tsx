  ...
  return (
    <div className="flex flex-col h-full overflow-hidden relative">
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Create call link - disabled for now */}
        ...
        {/* Call link banner - disabled for now */}
        {/* <AnimatePresence>
          {showCallLinkBanner && (
            <motion.div
            ...
            {calls.map(call => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    onClick={(e) => { e.stopPropagation(); console.warn('⚠️ Calls are disabled'); }}
      ...
      {/* New call sheet (contact picker) - disabled for now */}
      {/* <AnimatePresence>
        {showNewCallSheet && (
          <motion.div
            initial={{ y: '100%' }}
