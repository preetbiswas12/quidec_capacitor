    ...
    <div className="h-full w-full bg-wa-main flex flex-col items-center justify-between py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div 
          ...
          className="absolute top-[-20%] left-[-10%] w-[120%] h-[60%] bg-gradient-radial from-[#00A884]/30 to-transparent blur-[100px]"
        />
        <motion.div 
          animate={{ 
            scale: [1.3, 1, 1.3],
          ...
          className="absolute bottom-[-20%] right-[-10%] w-[120%] h-[60%] bg-gradient-radial from-[#00A884]/20 to-transparent blur-[100px]"
        />
      </div>
        ...
        >
          ...
          <div className="w-32 h-32 relative flex items-center justify-center">
            <motion.div
              ...
              className="absolute inset-0 border-2 border-dashed border-[#00A884]/30 rounded-[40px]"
            />
            <div className="w-24 h-24 bg-gradient-to-br from-[#00A884] to-[#01755b] rounded-[32px] flex items-center justify-center shadow-[0_0_80px_rgba(0,168,132,0.5)] relative z-20 overflow-hidden group">
               <motion.div
                 animate={{ y: [-2, 2, -2] }}
            ...
            <motion.div
              ...
              className="absolute inset-0 border border-[#00A884]/10 rounded-full scale-150"
            />
          </div>
        </motion.div>
        ...
        <div className="flex flex-col items-center gap-8">
          <div className="flex flex-col items-center">
            ...
            <motion.div 
              ...
              className="h-[1px] bg-gradient-to-r from-transparent via-[#00A884] to-transparent mt-2"
            />
          </div>
          ...
          <div className="w-64 flex flex-col gap-2">
            <div className="h-1 bg-wa-secondary/20 rounded-full overflow-hidden relative backdrop-blur-sm border border-wa-border/5">
              <motion.div
                ...
                className="h-full bg-gradient-to-r from-[#00A884]/50 to-[#00A884] shadow-[0_0_10px_#00A884]"
              />
            </div>
            <div className="flex justify-between px-1">
              ...
              <motion.span 
                ...
                className="text-[#00A884] text-[8px] font-bold"
              >
                LIVE
              </motion.span>
            </div>
