...
import { Phone, Video, PhoneCall, PhoneIncoming, PhoneMissed, PhoneOutgoing, ArrowLeft, Search, X } from 'lucide-react';
    ...
    <div className="flex flex-col h-full overflow-hidden relative">
            ...
            {calls.map(call => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    onClick={(e) => { e.stopPropagation(); startCall(contact.id, call.type as 'voice' | 'video'); }}
      ...
      <AnimatePresence>
        {showNewCallSheet && (
          ...
          >
            {/* Header */}
            <div className="flex items-center gap-3 px-4 py-4 bg-[#202C33] shrink-0">
              <button
