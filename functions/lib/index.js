...
exports.cleanupOrphanedCloudinaryChunks = exports.deleteCloudinaryChunks = void 0;
 ...
 */
exports.deleteCloudinaryChunks = functions.https.onCall(async (data, context) => {
    // Verify authentication
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated to delete chunks');
    }
 ...
 */
exports.cleanupOrphanedCloudinaryChunks = functions.pubsub
